...
import { Position, Team } from "../ff-types/types";

export type PositionInfo = Partial<Record<Position, number>>;
...
function EditLeagueSettings() {
  ...
  const [posInfo, setPosInfo] = useState<PositionInfo>({});
        ...
        .then(async () => {
          const reqBody = {
            ...
            teams: teams.map((team) => {
              return { ...team, leagueLogo: imageUrl };
            }),
            deletedTeams,
          };
          await fetch(
