...
import { AbbreviatedNflTeam, DatabasePlayer, FullNflTeam, SinglePosition } from "..";
...
export type TeamFantasyPositionPerformance = Record<FullNflTeam, FantasyPerformanceByPosition>;
export type TeamToSchedule = Record<FullNflTeam, Record<Week, AbbreviatedNflTeam | "BYE">>;
